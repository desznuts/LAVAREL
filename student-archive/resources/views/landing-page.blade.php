...
<body class="bg-gradient-to-r from-blue-50 via-white to-blue-50 text-gray-900 font-sans">
    <header class="bg-white shadow-md py-4 sticky top-0 z-50 ">
        <div class="max-w-7xl mx-auto px-6 flex items-center justify-between">
            <h1 class="text-4xl font-extrabold tracking-tight text-indigo-900 drop-shadow-md">
            ...
            <div>
                @auth
                    <a href="{{ route('dashboard') }}" class="hover:text-indigo-800 transition-colors duration-300 ml-6">Dashboard</a>
                @else
                    <a href="{{ route('login') }}" class="hover:text-indigo-800 transition-colors duration-300 ml-6">Login</a>
                    <a href="{{ route('register') }}" class="hover:text-indigo-800 transition-colors duration-300 ml-6">Register</a>
                @endauth
            </div>
        </div>
    </header>

    <main class="min-h-screen flex items-center justify-center px-6 py-12 bg-white dark:bg-gray-900">
         <section id="home" class="text-center fade-in-up max-w-3xl mx-auto">
            <h2 class="text-5xl font-extrabold mb-6 leading-tight tracking-tight text-gray-900 dark:text-white">
            ...
            <a href="{{ route('projects.index') }}"
                class="inline-block bg-gradient-to-r from-indigo-600 to-indigo-500 hover:from-indigo-700 hover:to-indigo-600 text-white px-8 py-4 rounded-lg shadow-lg text-lg font-semibold transition duration-300 ease-in-out transform hover:-translate-y-1 hover:shadow-xl">
                Browse Projects
            </a>
    </section>
